from model import LightningModel,SiameseNetwork
...
class Inference_prediction():
    def __init__(self, model_path):
        ...
        s=SiameseNetwork()
        self.model= LightningModel.load_from_checkpoint(self.model_path,map_location="cpu",model=s)
        self.model.eval()
        self.model.freeze()
    ...
    def predict(self,input1,input2):
        ...
        return (1-output.item())*100,sim.item()

if __name__ == "__main__":
    inference = Inference_prediction("best_model.ckpt")
    
    print(inference.predict("CEDAR/11/original_11_10.png","CEDAR/11/original_11_3.png"))