...
class SiameseNetwork(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        emb=pairwise_cosine_similarity(output2,output1,reduction="mean")
...
class CustomDataModule(l.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = CustomDataset("CEDAR_train.csv", transform=self.transform)
        self.val_dataset = CustomDataset("CEDAR_val.csv", transform=self.transform)
        self.test_dataset = CustomDataset("CEDAR_test.csv", transform=self.transform)
